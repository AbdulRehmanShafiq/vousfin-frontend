    ...
    <div className="premium-card p-5">
      ...
      <div className="flex items-center justify-between gap-2 mb-4">
        ...
        {!isLoading && !insufficient && conf && (
          <span
            className="px-2 py-0.5 rounded-full text-small font-bold uppercase tracking-wide flex-shrink-0"
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-small text-text-muted font-semibold">months</span>
              </div>
            </Stat>
            ...
            <Stat label="Forward health" hint={data.forwardHealth.level || undefined}>
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-small text-text-muted font-semibold">/100</span>
              </div>
            </Stat>
                ...
                return (
                  <div key={s.id || i} className="flex items-start gap-2">
                    ...
                    <div className="min-w-0">
                      <p className="text-small font-bold" style={{ color: meta.color }}>{s.title}</p>
                      <p className="text-small text-text-secondary leading-snug">{s.message}</p>
                    </div>
                  </div>
                )
              })}
