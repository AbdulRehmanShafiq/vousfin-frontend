...
import {
  ...
  Boxes, Library, Sparkles, Scale, Inbox, PackageSearch, Warehouse,
...
export const MODULES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Stock reports',     href: '/inventory/reports',       icon: PackageSearch,  desc: 'What stock is worth, how fast it sells, what it earns' },
      { name: 'Stock jobs',        href: '/inventory/stock-jobs',    icon: Warehouse,      desc: 'Locations, moving stock, and what you build' },
